      ...
      <div className="w-[97%] lg:w-[70%] ">
        <div className="flex justify-center items-center relative">
          <div className="flex flex-col items-center ">
            ...
            <div className="h-[3px] w-[290px] bg-pink-600 rounded-lg my-[2px]"></div>
            <div className="h-[3px] w-[350px] bg-pink-600 rounded-lg mt-[2px]"></div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="lg:w-[80%] w-full h-[200px] md:h-[250px] lg:h-[300px] bg-purple-700 mt-10">
